...
using RookiesFashion.APIService.ViewModels.CustomAuthentication;
...
namespace RookiesFashion.APIService.Controllers
{
    public class AuthController : Controller
    {
        ...
        public async Task<IActionResult> Login(string returnUrl)
        {
            ...
            return View(new LoginAuthModelVM
            {
                ReturnUrl = returnUrl,
        ...
        [HttpPost]
        public async Task<IActionResult> Login(LoginAuthModelVM vm)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Register(RegisterAuthModelVM vm)
        {
